...
function Checkout() {
  ...
  const totalAmount = router.query.totalAmount || 0;
  const shippingCost = 10;
  const total = parseFloat(totalAmount) + shippingCost;

  return (
    <div className="layout p-5 grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
      <div className="lg:col-span-3 bg-white rounded-lg shadow-lg p-5">
        <form>
